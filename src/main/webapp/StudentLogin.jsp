...
<%
    String useremail = request.getParameter("studentEmail");
    String userpass = request.getParameter("studentPass");
    ...
    ResultSet rs;
    rs = st.executeQuery("select * from library_user where useremail='" + useremail + "' and userpass='" + userpass + "'");
    if (rs.next()) {
