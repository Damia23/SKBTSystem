...
<body>
<header>
    <a href="LibrarianDashboard.jsp"><i class="fa fa-home" aria-hidden="true"></i>Home</a>
</header>
            ...
            <div class="table-title">
                <div class="row">
                    <%
                        ...
                        String dataa = "select * from library_user where useremail = '"+session.getAttribute("useremail")+"'";
                        rest = stats.executeQuery(dataa);
                        while(rest.next()){
                    %>
                    <div class="col-sm-6">
                        <h2>Borrow History for <%=rest.getString("username")%></h2>
                    </div>
                    <%
                        }
                    %>
